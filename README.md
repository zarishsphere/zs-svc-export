...
Data export service — FHIR bulk export, CSV, PDF reports
...
git clone https://github.com/zarishsphere/zs-svc-export.git
cd zs-svc-export
...
See [docs.zarishsphere.com/api/zs-svc-export](https://docs.zarishsphere.com/api/zs-svc-export) for the full OpenAPI 3.1 specification.
